...
<div class="main">
    ...
    <div class="juzhong">
        ...
        <div class="button"><a href="/StudentResult/toadd"><p>插入</p></a></div>
        <br>
        <div class="button"><a href="/StudentResult/toselect"><p>查找</p></a></div>
        <br>
        <div class="button"><a href="/StudentResult/todel"><p>删除</p></a></div>
        <br>
        <div class="button"><a href="/StudentResult/list"><p>输出</p></a></div>
        <br>
        <%--<button>退出</button>--%>
    </div>
</div>
